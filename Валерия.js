...
message.channel.send({
  embed: {
   ...
   files: [{
      attachment: 'https://downloader.disk.yandex.ru/preview/f6edfcacede10841baae988bb03837893e094fe479f20c308140e54ea0ce69e3/5b8de723/_B0aXmp4RJTYYcc2mgnKluOcn-5iBOhP-9h0kGRSKv-3NdsWe9y8fZujskxej9v-qu8q6OQpLh7Knynr51DWuw%3D%3D?uid=0&filename=Vinrael.png&disposition=inline&hash=&limit=0&content_type=image%2Fpng&tknv=v2&size=2048x2048',
      name: 'Win hero.png'
   }]
})
.then(console.log)
